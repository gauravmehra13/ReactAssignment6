    ...
    return(
      ...
      <section className="addSList-form">
            <form>
                <div>
                    <h3>Name:</h3>
                    <input type={'text'} placeholder={'Enter Your Name'} onChange={(e) => setSname(e.target.value)} value={Sname}  ></input>
    
                    <h3>Age:</h3>
                    <input type={'text'} placeholder={'Enter Your Age'} onChange={(e) => setSage(e.target.value)}  value={Sage}></input>
                </div>
                <div>
                    <h3>Course:</h3>
                    <input type={'text'} placeholder={'Enter Your Course'} onChange={(e) => setScourse(e.target.value)} value={Scourse} ></input>
                    
                    <h3>Batch:</h3>
                    <input type={'text'} placeholder={'Enter Your Batch'} onChange={(e)=> setSbatch(e.target.value)} value={Sbatch}></input>
                    <br></br>
                </div>
            </form>
